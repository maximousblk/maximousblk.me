...
For now, think of ECMAScript as versions of JavaScript. you can find more information [on MDN Web Docs](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Language_Resources).
